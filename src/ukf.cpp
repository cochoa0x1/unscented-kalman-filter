...
void UKF::Prediction(double delta_t) {
  ...
  //cout << "sigma before pred: " << endl << Xsig_aug_ << endl;
  //2. use the sigma points to estimate the mean and covariance
  SigmaPointPrediction(&Xsig_pred_,delta_t);
  //cout << "sigma AFTER pred: " << endl << Xsig_pred_ << endl;
  

  //3. apply the kalman filter update
  PredictMeanAndCovariance(&x_, &P_);

 // cout << "sigma AFTER predict mean and covar: " << endl << Xsig_pred_ << endl;
